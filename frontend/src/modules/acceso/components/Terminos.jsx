...
export const Terminos=()=>{
    return (
        <>
            <PanelCenter>
                <label className="text-green-800 text-xl font-bold">OPCIONES SACIMEX, S.A. DE C.V. SOFOM E.N.R TÉRMINOS Y CONDICIONES</label>
            </PanelCenter>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Datos de identificación.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                Esta página web es propiedad y está operado por <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> Estos Términos establecen los términos y condiciones bajo los cuales tú puedes usar nuestra página web y servicios ofrecidos por nosotros. Al acceder o usar la página web de nuestro servicio, usted aprueba que haya leído, entendido y aceptado estar sujeto a estos Términos:
                </label>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Derechos de propiedad intelectual e Industrial.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
            ...
            <div className="mt-3 text-justify">
                <ul>
                    ...
                    <li className="mt-3">
                        <label className="text-md"><label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label>, se reserva el derecho de revocar la autorización a que se refiere el número anterior en cualquier tiempo, y por tanto, el uso por parte del Usuario deberá interrumpirse inmediatamente a partir del momento en que reciba la notificación correspondiente de parte de <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label></label>
                    </li>
                    <li className="mt-3">
            ...
            <div className="mt-3">
                <ul>
                    ...
                    <li className="mt-4">
                        <label>Copiar o almacenar cualquier Contenido con propósitos diferentes de los mencionados expresamente en la sección de usos permitidos que antecede, sin contar con la autorización previa y por escrito de <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label>, o en su caso, del titular de los derechos de autor de que se trate.</label>
                    </li>
                </ul>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Condiciones de uso.</label>
            </div>
            <div className="mt-3  text-justify">
            ...
            <div className="mt-3 text-justify">
                <ul>
                    ...
                    <li className="mt-4">
                        <label>Mantener indemne a <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> ante cualquier posible reclamación, multa, pena o sanción que pueda venir obligada a soportar como consecuencia del incumplimiento por parte del USUARIO de cualquiera de las normas de utilización antes indicadas, reservándose, además, <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> el derecho a solicitar la indemnización por daños y perjuicios que corresponda.</label>
                    </li>
                </ul>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Limitación de responsabilidad.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> no realiza ningún tipo de asesoramiento al Usuario en ningún ámbito, ya sea fiscal, económico, contable, mercantil o cualquier otro. Por ello, las decisiones adoptadas por el Usuario son realizadas a título personal y en este acto exime a <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> de toda responsabilidad en la que incurra el Usuario por la obtención de los créditos.
                </label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> no asume ningún tipo de responsabilidad por fallos en la red de internet o por el ataque al software de cualquier hacker
                </label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                Usted declara ser conocedor de todos los riesgos que supone la contratación de los créditos por lo que exonera a <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> de cualquier responsabilidad por pérdidas incurridas o mal manejo o administración de recursos.
                </label>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Cookies</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                El Usuario que tenga acceso al Portal, acuerda recibir las Cookies que sean transmitidas por los servidores de <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label> Asimismo, el Usuario reconoce expresamente que las Cookies pueden contener información relativa a la identificación proporcionada por el Usuario o información para rastrear las Páginas que el Usuario ha visitado dentro del Portal, en el entendido, sin embargo, de que una Cookie no puede leer los datos o información del disco duro del Usuario, ni leer las Cookies creadas por otros Sitios o Páginas.
                </label>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Terminación.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
            ...
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Protección de datos personales.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                Los datos proporcionados por los Usuarios de este Portal, a manera enunciativa, y en ningún caso limitativa o excluyente, como personales, patrimoniales, financieros, son protegidos por lo dispuesto en la <label className="text-black-alpha-90 font-bold">Ley Federal de Protección de Datos Personales en Posesión de Particulares</label>, siendo  <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label>, responsable del tratamiento que se tenga con ellos.
                </label>
            </div>
            <div className="mt-3">
                <label className="text-md text-black-alpha-90 font-bold">Ley aplicable y Jurisdicción.</label>
            </div>
            <div className="mt-3 text-justify">
                <label>
                El presente Contrato se rige por las leyes mexicanas, para la interpretación, cumplimiento y ejecución del presente Contrato, las Partes se someten a los tribunales y Juzgados competentes del Estado de Oaxaca, renunciando expresamente a cualquier otro fuero que, por razón de sus domicilios, presentes o futuros, o por cualquier otra causa, pudiere corresponderles. <label className="text-black-alpha-90 font-bold">Opciones Sacimex, S.A. de C.V. SOFOM E.N.R.</label>, no realiza declaración u otorga garantía alguna en el sentido de que la información contenida en este Portal sea apropiada o disponible para ser utilizada en todos los países o jurisdicciones, y prohíbe accesar materiales desde territorios en donde los Servicios y Contenidos del Portal sean ilícitos. Aquellos Usuarios que acceden a este Portal, lo hacen por iniciativa propia y serán responsables de cumplir con las leyes aplicables en los lugares desde los cuales acceden al Portal.
                </label>
            </div>
        </>
    )
